...
car_nov <- month_ts(car_mn_av, 11)
ch_nov <- month_ts(ch_mn_av, 11)
bm_nov <- month_ts(bm_mn_av, 11)
nm_nov <- month_ts(nm_mn_av, 11)
dp_nov <- month_ts(dp_mn_av, 11) 
mp_nov <- month_ts(mp_mn_av, 11)

nov_dpth <- join_depth_months(carrizo = car_nov, chuska = ch_nov, black_mesa = bm_nov, defiance_plateau = dp_nov, mt_powell = mp_nov, navajo_mt = nm_nov)
...
car_dec <- month_ts(car_mn_av, 12)
ch_dec <- month_ts(ch_mn_av, 12)
bm_dec <- month_ts(bm_mn_av, 12)
nm_dec <- month_ts(nm_mn_av, 12)
dp_dec <- month_ts(dp_mn_av, 12) 
mp_dec <- month_ts(mp_mn_av, 12)

dec_dpth <- join_depth_months(carrizo = car_dec, chuska = ch_dec, black_mesa = bm_dec, defiance_plateau = dp_dec, mt_powell = mp_dec, navajo_mt = nm_dec)
...
- peak snow depth is usually December - January
