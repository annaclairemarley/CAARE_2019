...
nov_swe_plot <- month_bplot_swe(nov_swe, "November Swe")
...
dec_swe_plot <- month_bplot_swe(dec_swe, "December Swe")
...
jan_swe_plot <- month_bplot_swe(jan_swe, "January Swe")
...
```{r, echo = FALSE}
# plot box plot for each month
feb_swe_plot <- month_bplot_swe(feb_swe, "March Swe")
```
...
mar_swe_plot <- month_bplot_swe(mar_swe, "March Swe")
...
apr_swe_plot <- month_bplot_swe(apr_swe, "April Swe")
```
