...
### Chuska annual weekly average max SWE
```{r, echo = FALSe}
# read in data
ch_max_weekly_yr <- read_csv("Chuska/ch_swe_max_week_yr.csv")
...
```{r, echo = FALSE}
# make graph
ch_wk_max_graph <- ch_max_weekly_yr %>% 
  ...
  labs(
    ...
    subtitle = "Trendline: y = -0.2250x + 473.0250 | p-value = 0.436"
  ) +
