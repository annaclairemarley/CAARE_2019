...
```{r,fig.width=20,fig.height=5, echo= FALSE}
# graph it
carr_med_graph <- graph_SWE_with_wateryear(carr_mnth_med, "Carrizo")
carr_med_graph
```

```{r,fig.width=20,fig.height=5, echo= FALSE}
ch_med_graph <- graph_SWE_with_wateryear(ch_mnth_med, "Chuska")
ch_med_graph
```

```{r,fig.width=20,fig.height=5, echo= FALSE}
bm_med_graph <- graph_SWE_with_wateryear(bm_mnth_med, "Black Mesa")
bm_med_graph
```
...
```{r,fig.width=20,fig.height=5, echo= FALSE}
#graph it
car_anom_graph <- plot_swe_anomaly(car_anom, title = "Carrizo")
car_anom_graph
```

```{r,fig.width=20,fig.height=5, echo= FALSE}
ch_anom_graph <- plot_swe_anomaly(ch_anom, title = "Chuska")
ch_anom_graph

```

```{r,fig.width=20,fig.height=5, echo= FALSE}
bm_anom_graph <- plot_swe_anomaly(bm_anom, title = "Black Mesa")
bm_anom_graph
...
corr_chu_bm <- cor.test(bm_weekly$swe_mm, ch_weekly$swe_mm)
corr_chu_carr <- cor.test(carr_weekly$swe_mm, ch_weekly$swe_mm)
corr_carr_bm <- cor.test(bm_weekly$swe_mm, carr_weekly$swe_mm)
