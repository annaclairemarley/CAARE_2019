...
```{r, include=FALSE}
# create the monthly mean dataframes
carr_mnth_med <- calc_snow_metrics(car_wint_wy, "month", median)
ch_mnth_med <- calc_snow_metrics(ch_wint_wy, "month", median)
bm_mnth_med <- calc_snow_metrics(bm_wint_wy, "month", median)
```
