...
nn_mts_spi_apr_plot <- plot_cor_swe_spi(nn_mts_spi_apr,
                                          title = "Winter SWE Anomaly & April SPI")

nn_mts_spi_may <- merge_ch_spi(nn_spi, df_swe = mtns_swe_wint_anomaly, months = c(5)) 
nn_mts_spi_may_plot <- plot_cor_swe_spi(nn_mts_spi_may,
                                          title = "Winter SWE Anomaly & May SPI")

nn_mts_spi_june <- merge_ch_spi(nn_spi, df_swe = mtns_swe_wint_anomaly, months = c(6)) 
nn_mts_spi_june_plot <- plot_cor_swe_spi(nn_mts_spi_june,
                                          title = "Winter SWE Anomaly & June SPI")

nn_mts_spi_july <- merge_ch_spi(nn_spi, df_swe = mtns_swe_wint_anomaly, months = c(7)) 
nn_mts_spi_july_plot <- plot_cor_swe_spi(nn_mts_spi_july,
...
grid.arrange(nn_mts_spi_apr_plot, nn_mts_spi_may_plot, 
             nn_mts_spi_june_plot, nn_mts_spi_july_plot, ncol = 2)
...
plot_spi_drought_level(nn_spi, month = all_months, region_time = "Navajo Nation 6 month") 
```
