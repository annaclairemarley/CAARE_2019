...
# merge with spi
chaco_spi_pdsi_june <- merge_pdsi_spi(chaco_spi, months = c(6), chaco_pdsi_jun_6)

# find and plot the correlation between the two
plot_cor_pdsi_spi(chaco_spi_pdsi_june, title = "Chaco June 6 month")
...
# merge with spi
chinle_spi_pdsi_june <- merge_pdsi_spi(chinle_spi, months = c(6), chinle_pdsi_jun_6 ) 

# find and plot the correlation between the two
plot_cor_pdsi_spi(chinle_spi_pdsi_june, title = "Chinle June 6 month")
...
# merge with spi
mid_sj_spi_pdsi_june <- merge_pdsi_spi(mid_sj_spi, months = c(6), mid_sj_pdsi_jun_6 )  


# find and plot the correlation between the two
mid_sj_spi_pdsi_plot <- plot_cor_pdsi_spi(mid_sj_spi_pdsi_june, 
                                          title = "Middle San Juan June 6 month")
mid_sj_spi_pdsi_plot
...
```{r, echo = FALSE}
# read in the PDSI January-June 6 month average 
up_puerco_pdsi_jun_6 <- read_csv("watersheds/up_puerco_pdsi_jun_6.csv")

# merge with spi
up_puerco_spi_pdsi_june <- merge_pdsi_spi(up_pue_spi, months = c(6), up_puerco_pdsi_jun_6 )  

# find and plot the correlation between the two
up_puerco_spi_pdsi_plot <- plot_cor_pdsi_spi(up_puerco_spi_pdsi_june, 
                                          title = "Upper Puerco June 6 month")
up_puerco_spi_pdsi_plot
